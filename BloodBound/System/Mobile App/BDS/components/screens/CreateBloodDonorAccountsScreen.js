...
export default function CreateBloodDonorAccountScreen(props) {
            ...
            <DocCounter/>
            {
                docCounter.map((num, index) => (
                    <Pressable key={index} style={[styles.uploadButton, { backgroundColor: '#D600FF'}]} onPress={() => openImagePickerAsync('docs', index)}>
                        ...
                        <Text style={styles.buttonText}>Upload Photos of your previous (recent) donation.</Text>
                    </Pressable>
                ))
            }
        </View>
    ...
    const convertUser = () => {
        ...
        const user = { username, firstName, middleName, lastName, userType: 'Blood_Donor', email: (email != "" ? email: null), phoneNumber: (phoneNumber != "" ? phoneNumber : null), bloodType: chosenBloodType, cnic, cnicPhoto, livePhoto, verificationDocs: verificationDocs.filter(doc => doc != "") };
        ...
        <View style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.logInForm}>
                        <Text style={{left: 12}}>Please enter the donor's details to create an account.</Text>
                        <FlatList
                            data={BloodTypes}
                        ...
                        <Pressable style={[styles.uploadButton, { backgroundColor: '#FF00DD'}]} onPress={() => openImagePickerAsync('selfie')}>
                            ...
                            <Text style={styles.buttonText}>Upload Passport Photo of Donor</Text>
                        </Pressable>
						<VerificationImages/>
