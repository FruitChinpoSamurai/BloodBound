...
import ReportedList from '../utilities/ReportedList';
...
export default function ManageReportedUsersScreen(props) {
	...
	React.useEffect(() => dispatch(getReports()), [reportsFiled]);
