...
const getUserNew = (username, tok = null) => {
    if (tok) {
        token = tok;
    }
    return API.get(userUrl + `?username=${username}`); //search by username
}
...
export const getUser = (username, tok = null) => getUserNew(username, tok);
